    ...
    <section className="bg-background py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-balance text-3xl font-bold tracking-tight text-primary sm:text-4xl">How It Works</h2>
        ...
        <div className="relative mt-14 grid grid-cols-1 gap-12 sm:grid-cols-3">
          <div
            className="absolute left-[16.66%] right-[16.66%] top-7 hidden border-t border-dashed border-border sm:block"
            aria-hidden="true"
          />
          {steps.map((step) => (
            <div key={step.number} className="relative flex flex-col items-center text-center">
              <div className="flex size-14 items-center justify-center rounded-full bg-accent text-xl font-bold text-accent-foreground shadow-md ring-8 ring-background">
                {step.number}
              </div>
