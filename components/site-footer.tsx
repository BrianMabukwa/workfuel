...
import { Phone, Mail, MapPin, Building2, GraduationCap, Car, Headphones, CalendarDays, ShieldCheck } from "lucide-react"
...
export function SiteFooter() {
  return (
    <footer>
      ...
      {/* Bottom section */}
      <div className="bg-[#0a231c] text-white">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wide text-[#e8a317]">Contact Info</h3>
              <ul className="mt-4 space-y-3 text-sm text-white/80">
                <li className="flex items-center gap-2">
                  <Phone className="size-4 text-[#e8a317]" /> WhatsApp: 067 064 5653
                </li>
                <li className="flex items-center gap-2">
                  <Mail className="size-4 text-[#e8a317]" /> workfuelsa@gmail.com
                </li>
                <li className="flex items-center gap-2">
                  <MapPin className="size-4 text-[#e8a317]" /> Johannesburg, South Africa
                </li>
              </ul>
            </div>

            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wide text-[#e8a317]">Our Services</h3>
              <ul className="mt-4 space-y-3 text-sm text-white/80">
                <li>
                  <Link href="/snack-boxes" className="transition-colors hover:text-[#e8a317]">
                    Budget Boxes
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/add-ons" className="transition-colors hover:text-[#e8a317]">
                    Corporate Gifting
                  </Link>
                </li>
                <li>
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wide text-[#e8a317]">Ready to Fuel?</h3>
              <p className="mt-4 text-sm text-white/70">Start your first subscription or order a trial box today.</p>
              <Link
                href="/checkout"
                className="mt-4 inline-flex w-full items-center justify-center rounded-lg border-2 border-[#e8a317] bg-transparent px-6 py-3 text-sm font-semibold text-[#e8a317] transition-all hover:bg-[#e8a317] hover:text-[#0f2d24]"
              >
                Order Now
              </Link>
            </div>
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-5 text-sm text-white/60 sm:flex-row sm:px-6 lg:px-8">
            <p>&copy; 2024 WorkFuel SA. Fueling Productive Teams in Johannesburg.</p>
            <div className="flex gap-6">
              <Link href="#" className="transition-colors hover:text-[#e8a317]">
                Privacy Policy
              </Link>
              <Link href="#" className="transition-colors hover:text-[#e8a317]">
                Terms of Service
